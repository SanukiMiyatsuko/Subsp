...
def idxb3 (u:Nat) : T → Bool | T.Z => true | T.P p _ t => decide (p≤u) && idxb3 u t
#eval idxb3 0 (T.one_del (auxSum (v3 z z one)))
#eval idxb3 0 (T.one_del (auxSum (v3 z one one)))
#eval idxb3 0 (T.one_del (auxSum (v3 z z two)))
