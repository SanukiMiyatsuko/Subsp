...
theorem co_transAux_card1_lex {lam : Nat} :
  ...
  | zero =>
      ...
      | inr heq =>
        apply Or.inr
        constructor
        · rw [hsv, hsw, T.card_times.eq_1, T.card_times.eq_1]
        · exact heq.2
  | succ m ih =>
      intro v w hv hw hmono hcmp fv fw sv av sw aw hav haw
      cases v with
              ...
              | mk fwr qr =>
                ...
                | mk swr awr =>
                  ...
                  | lt =>
                    ...
                    cases m with
                    | zero =>
                      have hsv : svr = T.Z := co_len1_sum_zero xv fvr svr avr havrest
                      have hsw : swr = T.Z := co_len1_sum_zero xw fwr swr awr hawrest
                      rw [hsv, hsw]
                  ...
                  | eq =>
                    ...
                    | Z =>
                      change
                        T.card_times 1 svr < T.card_times 1 swr ∨
                          (T.card_times 1 svr = T.card_times 1 swr ∧ avr < awr)
                      exact hrec
                    | P als aadd =>
                      cases m with
                      | zero =>
                        ...
                        cases hrec with
                        | inl hbad =>
                          rw [hsv, hsw, T.card_times.eq_1, T.card_times.eq_1] at hbad
