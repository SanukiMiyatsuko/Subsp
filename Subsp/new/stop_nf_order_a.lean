  ...
  | P s0 s1 s2 =>
    ...
    · cases hp : T.part s2 with
      | mk a b =>
        ...
        by_cases_dec hhead : T.head b ≤ T.P 0 p T.Z
...
theorem part_lt_cases : ∀ s t : T, s < t →
  ...
  | P p x y ihx ihy =>
    ...
    | P q u v =>
      rw [T.part]
      rw [T.part]
      by_cases_dec hp0 : p = 0
      · rw [ite_eq_left hp0]
        by_cases_dec hq0 : q = 0
        · rw [ite_eq_left hq0]
          exact Or.inr ⟨rfl, h⟩
        · rw [ite_eq_right hq0]
...
theorem bridge_insert_lt (a b d : T)
  ...
  | inl hbz =>
    ...
    | inr hdp =>
      ...
      by_cases_dec hfa : T.P 0 f T.Z ≤ T.P 0 a T.Z
      · rw [ite_eq_left hfa]
  ...
  | inr hbp =>
    ...
    | inr hdp =>
      ...
      change
        ...
        (if T.P 0 f T.Z ≤ T.P 0 a T.Z then
          T.P 0 a (T.P 0 f g) else T.P 0 f g)
      by_cases_dec hca : T.P 0 c T.Z ≤ T.P 0 a T.Z
      · rw [ite_eq_left hca]
        by_cases_dec hfa : T.P 0 f T.Z ≤ T.P 0 a T.Z
        · rw [ite_eq_left hfa]
...
theorem bridge_part_fst_le_self (s : T) : (T.part s).1 ≤ s := by
  by_cases_dec hb : (T.part s).2 = T.Z
  · have hadd := bridge_part_add s
...
theorem bridge_early_collapse_upper (s c : T)
  ...
  | mk a b =>
    ...
    · rw [hec, ite_eq_right ha]
      by_cases_dec hhead : T.head b ≤ T.P 0 a T.Z
      · rw [ite_eq_left hhead]
...
theorem bridge_part_base_le_early_collapse (t : T)
  ...
  | mk c d =>
    ...
    by_cases_dec hhead : T.head d ≤ T.P 0 c T.Z
    · rw [ite_eq_left hhead]
      cases T.Z_le d with
      | inl hzd =>
    ...
    | snoc n xs a =>
        ...
        | mk found rest =>
          ...
          | mk sum a0 =>
            ...
            by_cases_dec hecz : T.early_collapse (trans a) = T.Z
...
theorem ec_wrap_fst_le (t c d : T)
  ...
  by_cases_dec hkeep : T.head d ≤ T.P 0 c T.Z
  · rw [ite_eq_left hkeep]
    cases d with
    | Z => exact Or.inr rfl
    | P p e f =>
...
theorem ec_same_fst_mono (s t a b d : T)
  ...
  · rw [ite_eq_left ha, ite_eq_left ha]
    ...
    exact hbd
  · rw [ite_eq_right ha, ite_eq_right ha]
    by_cases_dec hbkeep : T.head b ≤ T.P 0 a T.Z
    · rw [ite_eq_left hbkeep]
      by_cases_dec hdkeep : T.head d ≤ T.P 0 a T.Z
